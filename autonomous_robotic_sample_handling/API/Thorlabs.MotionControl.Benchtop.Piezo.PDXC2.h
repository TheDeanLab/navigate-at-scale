...
#pragma pack(1)
	...
	struct PZ_JogParameters
	{
		/// <summary> The jog mode. </summary>
		PZ_JogModes Mode;
		/// <summary> Size of the jog step. </summary>
		__int32 StepSize;
		/// <summary> The jog rate. </summary>
		__int32 Rate;
		/// <summary> The jog acceleration. </summary>
		__int32 Acceleration;
	};
	...
	/// <summary> Values that represent Jog Modes. </summary>
	...
	enum PDXC2_SPRLoopMode : unsigned __int16
	{
	...
	enum PDXC2_SPRDirection : unsigned __int16
	{
	...
	typedef struct
	{
		/// <summary> MoveDirection. </summary>
		MOT_TravelDirection Direction;
		/// <summary> Desire frequency of output pulse. Range from 800 to 20000 Hz </summary>
		unsigned __int16 Frequency;
		/// <summary> The jog step size. Range 1 - 65535 </summary>
	...
	/// <summary> PDXC2 Step, Pulse and Response parameters. </summary>
	typedef struct
	{
		/// <summary> The loop mode</summary>
		PDXC2_SPRLoopMode LoopMode;
		/// <summary>  The falling edge fixed step in nm </summary>
		PDXC2_SPRDirection Direction;
		/// <summary> The move distance from 0 to 20,000,000 (nm)</summary>
		__int32 Distance;
	} PDXC2_SPRParameters;
...
#pragma pack()
	...
	/// <summary>	Request the open loop move (jog)  parameters. </summary>
	/// <param name="serialNo">	The device serial no. </param>
	/// <returns>	The error code (see \ref C_DLL_ERRORCODES_page "Error Codes") or zero if successful. </returns>
	BENCHPIEZO_API short __cdecl  PDXC2_RequestOpenLoopMoveParams(char const* serialNo);

	/// <summary> Sets the open loop move (jog)  parameters. </summary>
	/// <param name="serialNo">	The device serial no. </param>
	/// <param name="params"> Options for controlling open loop move (jog) parameters. </param>
	/// <returns> The error code (see \ref C_DLL_ERRORCODES_page "Error Codes") or zero if successful. </returns>
	...
	/// <returns> The error code (see \ref C_DLL_ERRORCODES_page "Error Codes") or zero if successful. </returns>
	BENCHPIEZO_API short __cdecl  PDXC2_SetJogParams(char const* serialNo, PZ_JogParameters* params);

	/// <summary> Gets the jog  parameters. </summary>
	/// <param name="serialNo">	The device serial no. </param>
	/// <param name="params"> Options for controlling jog parameters. </param>
	/// <returns> The Options for controlling joge parameters. </returns>
	BENCHPIEZO_API short __cdecl  PDXC2_GetJogParams(char const* serialNo, PZ_JogParameters* params);
	...
	/// <summary>	Request the HID (joystick) step distance. </summary>
	/// <param name="serialNo">	The device serial no. </param>
	/// <returns>	The error code (see \ref C_DLL_ERRORCODES_page "Error Codes") or zero if successful. </returns>
	BENCHPIEZO_API short __cdecl PDXC2_RequestJoystickStepDistance(char const* serialNo);

	/// <summary> Sets the HID (joystick) step distance. </summary>
	/// <param name="serialNo">	The device serial no. </param>
	/// <param name="stepDistance"> The step distance in nm. </param>
	/// <returns> The error code (see \ref C_DLL_ERRORCODES_page "Error Codes") or zero if successful. </returns>
	BENCHPIEZO_API short __cdecl PDXC2_SetJoystickStepDistance(char const* serialNo, int stepDistance);

	/// <summary> Gets the HID (joystick) step distance. </summary>
	/// <param name="serialNo">	The device serial no. </param>
	/// <returns> The step distance in nm. </returns>
	BENCHPIEZO_API int __cdecl PDXC2_GetJoystickStepDistance(char const* serialNo);
